...
&emsp;&emsp;&emsp;1.禁止一名参议员的权利：

&emsp;&emsp;&emsp;参议员可以让另一位参议员在这一轮和随后的几轮中丧失**所有的权利。**

&emsp;&emsp;&emsp;2.宣布胜利：

&emsp;&emsp;&emsp;如果参议员发现有权利投票的参议员都是**同一个阵营的**，他可以宣布胜利并决定在游戏中的有关变化。
...
<span style="color:green">这里有一个技巧，就是用一个变量记录当前参议员之前有几个敌对对手了，进而判断自己是否被消灭了。这个变量我用flag来表示。</span>
...
public:
    string predictPartyVictory(string senate) {
        ...
        int flag = 0;
        while(R && D){  //一旦R或者D为false，就结束循环，说明本轮结束之后只剩下R或者D了
            R = false;
            D = false;
